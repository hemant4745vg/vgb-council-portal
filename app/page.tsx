...
/* =========================================================
   COUNCIL PORTAL DATA
   Public-facing 2026–27 leadership structure.
========================================================= */

interface CouncilMember {
  name: string;
  classLabel: 'Class XII' | 'Class XI';
  role: string;
  house?: string;
}
...
const SCHOOL_COUNCIL = [
  { area: 'Headship',
    primary: [
      { name: 'Vinay Kumar Maurya', classLabel: 'Class XII', role: 'Head Boy' },
      { name: 'Satakshi Gangwar', classLabel: 'Class XII', role: 'Head Girl' },
    ],
    supporting: [
      { name: 'Abhimanyu Singh', classLabel: 'Class XI', role: 'Vice Head Boy' },
      { name: 'Kirti Singh', classLabel: 'Class XI', role: 'Vice Head Girl' },
    ] },
  { area: 'Sports',
    primary: [
      { name: 'Nitin', classLabel: 'Class XII', role: 'Sports Captain · Boy' },
      { name: 'To be confirmed', classLabel: 'Class XII', role: 'Sports Captain · Girl' },
    ],
    supporting: [
      { name: 'Abhimanyu', classLabel: 'Class XI', role: 'Vice Sports Captain · Boy' },
      { name: 'Nainshee Mishra', classLabel: 'Class XI', role: 'Vice Sports Captain · Girl' },
    ] },
  { area: 'Honour',
    primary: [
      { name: 'Krish', classLabel: 'Class XII', role: 'Honour Secretary · Boy' },
      { name: 'Pravesh', classLabel: 'Class XII', role: 'Honour Secretary · Girl' },
    ],
    supporting: [
      { name: 'Hemant Rathore', classLabel: 'Class XI', role: 'Joint Honour Secretary · Boy' },
      { name: 'Tejaswani', classLabel: 'Class XI', role: 'Joint Honour Secretary · Girl' },
    ] },
  { area: 'Cultural',
    primary: [
      { name: 'Dheeraj', classLabel: 'Class XII', role: 'Cultural Secretary · Boy' },
      { name: 'To be confirmed', classLabel: 'Class XII', role: 'Cultural Secretary · Girl' },
    ],
    supporting: [
      { name: 'Aditya Mauya', classLabel: 'Class XI', role: 'Joint Cultural Secretary · Boy' },
      { name: 'Satakshi Sharma', classLabel: 'Class XI', role: 'Joint Cultural Secretary · Girl' },
    ] },
] satisfies Array<{ area: string; primary: CouncilMember[]; supporting: CouncilMember[] }>;

const HOUSE_COUNCIL = [
  { house: 'Jal',
    primary: [
      { name: 'Sachin Sahani', classLabel: 'Class XII', role: 'House Captain · Boy', house: 'Jal' },
      { name: 'To be confirmed', classLabel: 'Class XII', role: 'House Captain · Girl', house: 'Jal' },
    ],
    supporting: [
      { name: 'Harshit Yadav', classLabel: 'Class XI', role: 'Vice House Captain · Boy', house: 'Jal' },
      { name: 'Aditi Singh', classLabel: 'Class XI', role: 'Vice House Captain · Girl', house: 'Jal' },
    ] },
  { house: 'Vayu',
    primary: [
      { name: 'Himanshu Kumar Gautam', classLabel: 'Class XII', role: 'House Captain · Boy', house: 'Vayu' },
      { name: 'To be confirmed', classLabel: 'Class XII', role: 'House Captain · Girl', house: 'Vayu' },
    ],
    supporting: [
      { name: 'Rishabh Yadav', classLabel: 'Class XI', role: 'Vice House Captain · Boy', house: 'Vayu' },
      { name: 'Jigyasa Rajawat', classLabel: 'Class XI', role: 'Vice House Captain · Girl', house: 'Vayu' },
    ] },
  { house: 'Agni',
    primary: [
      { name: 'To be confirmed', classLabel: 'Class XII', role: 'House Captain · Boy', house: 'Agni' },
      { name: 'To be confirmed', classLabel: 'Class XII', role: 'House Captain · Girl', house: 'Agni' },
    ],
    supporting: [
      { name: 'Krishna Kumar Dwivedi', classLabel: 'Class XI', role: 'Vice House Captain · Boy', house: 'Agni' },
      { name: 'Divya', classLabel: 'Class XI', role: 'Vice House Captain · Girl', house: 'Agni' },
    ] },
  { house: 'Prithvi',
    primary: [
      { name: 'To be confirmed', classLabel: 'Class XII', role: 'House Captain · Boy', house: 'Prithvi' },
      { name: 'To be confirmed', classLabel: 'Class XII', role: 'House Captain · Girl', house: 'Prithvi' },
    ],
    supporting: [
      { name: 'Ritesh Pal', classLabel: 'Class XI', role: 'Vice House Captain · Boy', house: 'Prithvi' },
      { name: 'Vedika Singh', classLabel: 'Class XI', role: 'Vice House Captain · Girl', house: 'Prithvi' },
    ] },
] satisfies Array<{ house: string; primary: CouncilMember[]; supporting: CouncilMember[] }>;
...
export default function Home() {
  ...
  const handleCreateEvent = async (
    ...
    if (!session) {
      ...
      setMessage('Please sign in to publish an event.');
    ...
    if (!newTitle.trim() || !newDate || !newCategory) {
    ...
    if (error) {
      ...
      setMessage(
        ...
        'The event could not be published. Please check your access and try again.'
  ...
  return (
    ...
    <div className="min-h-screen bg-[#f7f8f5] text-slate-900 font-sans">
        ...
        <div className="max-w-7xl mx-auto px-5 lg:px-8">
          ...
          <div className="h-[72px] flex items-center justify-between gap-5">
            ...
            <button
              ...
              className="lg:hidden inline-flex h-10 w-10 items-center justify-center rounded-lg border border-slate-200 bg-white text-blue-950"
          ...
          {mobileMenuOpen && (
            ...
            <nav className="lg:hidden border-t border-slate-200 py-3">

              <div className="grid gap-1 pb-2 text-sm font-medium text-slate-700">
                ...
                {[
                  ...
                  <a
                    ...
                    className="rounded-xl px-4 py-3 hover:bg-slate-100 hover:text-blue-950"
                ...
                {session && (
                  ...
                  <a
                    ...
                    className="rounded-xl px-4 py-3 bg-blue-50 text-blue-950 font-semibold"
      ...
      >
        ...
        >
          ...
          {calendarError && (
            ...
            <div className="mb-4 rounded-2xl border border-amber-200 bg-amber-50 px-4 py-3 text-xs text-amber-800">
              ...
              Live calendar data is temporarily unavailable. The annual school calendar is still shown below.
                              ...
                              <div>
                                ...
                                <div className="flex flex-wrap items-center gap-2">
                                  ...
                                  {event.event_date === today && (
                                    ...
                                    <span className="inline-flex px-2 py-0.5 rounded-full bg-emerald-50 text-emerald-700 text-[9px] font-bold uppercase tracking-wide">
        ...
        <section id="council" className="mt-12 scroll-mt-24">
          <SectionHeading
            eyebrow="Council Portal"
            title="Student Council · 2026–27"
            description="The public leadership structure of VidyaGyan Leadership Academy, with Class XII office-bearers and their corresponding Class XI Vice or Joint office-bearers."
          />

          <div className="rounded-[1.75rem] bg-blue-950 p-6 md:p-8 text-white shadow-sm">
            <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-5">
              <div>
                <div className="text-[10px] font-bold uppercase tracking-[0.2em] text-emerald-300">
                  School Council
                </div>
                <h3 className="mt-2 text-2xl md:text-3xl font-bold">Student Leadership</h3>
                <p className="mt-2 text-sm leading-6 text-blue-200 max-w-2xl">
                  Class XII serves as the primary office-bearing tier. Class XI serves in the corresponding Vice or Joint positions.
                </p>
              </div>
              <span className="self-start md:self-auto rounded-full bg-white/10 px-3 py-1.5 text-[10px] font-bold uppercase tracking-[0.16em] text-blue-100">
                2026–27
              </span>
            </div>

            <div className="mt-8 grid lg:grid-cols-2 gap-5">
              {SCHOOL_COUNCIL.map((group) => (
                <div key={group.area} className="rounded-2xl border border-white/10 bg-white/[0.06] p-5">
                  <div className="text-[10px] font-bold uppercase tracking-[0.18em] text-emerald-300">
                    {group.area} Leadership
                  </div>
                  <div className="mt-4 grid sm:grid-cols-2 gap-3">
                    {group.primary.map((member) => (
                      <div key={`${member.role}-${member.name}`} className="rounded-xl bg-white p-4 text-blue-950">
                        <div className="text-[10px] font-bold uppercase tracking-[0.12em] text-emerald-700">{member.role}</div>
                        <div className="mt-2 font-bold text-sm">{member.name}</div>
                        <div className="mt-1 text-[11px] text-slate-500">{member.classLabel}</div>
                      </div>
                    ))}
                    {group.supporting.map((member) => (
                      <div key={`${member.role}-${member.name}`} className="rounded-xl border border-white/10 bg-white/[0.03] p-4">
                        <div className="text-[10px] font-bold uppercase tracking-[0.12em] text-blue-200">{member.role}</div>
                        <div className="mt-2 font-bold text-sm text-white">{member.name}</div>
                        <div className="mt-1 text-[11px] text-blue-200">{member.classLabel}</div>
                      </div>
                    ))}
                  </div>
                </div>
          ...
          <div className="mt-8">
            <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-3 mb-5">
              <div>
                <div className="text-[10px] font-bold uppercase tracking-[0.18em] text-emerald-700">House Council</div>
                <h3 className="mt-2 text-2xl font-bold tracking-tight text-blue-950">Four Houses · Two Leadership Tiers</h3>
              </div>
              <p className="text-xs text-slate-500 max-w-md">
                Each house is shown with its Class XII House Captains and Class XI Vice House Captains.
              </p>
            </div>

            <div className="grid md:grid-cols-2 xl:grid-cols-4 gap-4">
              {HOUSE_COUNCIL.map((house) => (
                <div key={house.house} className="rounded-[1.5rem] border border-slate-200/80 bg-white p-5 shadow-sm">
                  <div className="flex items-center justify-between gap-3">
                    <h4 className="text-xl font-bold text-blue-950">{house.house}</h4>
                    <span className="rounded-full bg-emerald-50 px-2.5 py-1 text-[10px] font-bold uppercase tracking-[0.12em] text-emerald-700">House</span>
                  </div>
                  <div className="mt-5 space-y-3">
                    {house.primary.map((member) => (
                      <div key={`${member.role}-${member.name}`} className="rounded-xl bg-slate-50 p-3">
                        <div className="text-[9px] font-bold uppercase tracking-[0.12em] text-slate-500">{member.role}</div>
                        <div className="mt-1 text-sm font-semibold text-blue-950">{member.name}</div>
                        <div className="mt-0.5 text-[10px] text-slate-400">{member.classLabel}</div>
                      </div>
                    ))}
                    {house.supporting.map((member) => (
                      <div key={`${member.role}-${member.name}`} className="rounded-xl border border-slate-200 p-3">
                        <div className="text-[9px] font-bold uppercase tracking-[0.12em] text-emerald-700">{member.role}</div>
                        <div className="mt-1 text-sm font-semibold text-blue-950">{member.name}</div>
                        <div className="mt-0.5 text-[10px] text-slate-400">{member.classLabel}</div>
                      </div>
                    ))}
        ...
        <div className="max-w-7xl mx-auto px-5 lg:px-8 py-10">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <a href="#council" className="hover:text-blue-950">
                Council Portal
              </a>
